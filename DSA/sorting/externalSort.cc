...
int main()
{
    ...
    time_point<high_resolution_clock> start, cerate_input, end;
    ...
    fclose(in);
    cerate_input = high_resolution_clock::now();
    auto d1 = duration_cast<milliseconds>(cerate_input - start);
    std::cout << "Created input data file (" << input_file << ") in : " << d1.count() << " ms.\n";
    externalSort(input_file, output_file, num_ways,
                 run_size);
    end = high_resolution_clock::now();
    auto d2 = duration_cast<milliseconds>(end-cerate_input);
    std::cout << "Created output data file (" << output_file << ") in : " << d2.count() << " ms.\n";
